...
```powershell
PS C:\irix> Get-HotFix | ft -AutoSize
...
```powershell
PS C:\irix> Get-WmiObject -Class Win32_Product |  select Name, Version
...
```powershell
C:\irix> net localgroup administrators
